...
using MRA.Jobs.SSR.Client.Components.Pages.Admin.Dialogs;
using MudBlazor;
...
public partial class VacancyPage
{
    ...
    public async void InsertImage()
    {
        ...
        {
            await this._quillHtml.InsertImage(_imageLinkToInsertToEditor);
            StateHasChanged();
        }
    }
    ...
    {
        VService.creatingNewJob.Description = await this._quillHtml.GetHTML();
    ...
    public async Task OnEditClick(string slug)
    {
        ...
        await this._quillHtml.LoadHTMLContent(vacancy.Description);
