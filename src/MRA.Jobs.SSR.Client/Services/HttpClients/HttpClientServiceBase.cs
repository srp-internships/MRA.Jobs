...
public abstract class HttpClientServiceBase(IHttpClientFactory httpClientFactory, ILocalStorageService cookieUtil,
    IConfiguration configuration) : IHttpClientServiceBase
{
    ...
    private async Task<HttpClient> CreateHttpClient()
    {
        ...
        JwtTokenResponse authToken = null;//await cookieUtil.GetItemAsync<JwtTokenResponse>("authToken");
        if (authToken!=null)
