...
namespace MRA.Identity.ClientWebApp.Services.Auth;
...
public class AuthService(HttpClient httpClient,
        ...
        IHttpContextAccessor httpContextAccessor, LayoutService layoutService, IUserProfileService userProfileService, IConfiguration configuration)
    : IAuthService
{
    ...
    public async Task<string> LoginUserAsync(LoginUserCommand command, bool newRegister = false)
    {
        ...
        try
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                ...
                httpContextAccessor.HttpContext?.Response.Cookies.Append("authToken", JsonConvert.SerializeObject(response));
