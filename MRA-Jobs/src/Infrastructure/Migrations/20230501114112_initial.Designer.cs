...
namespace MRA_Jobs.Infrastructure.Migrations
{
    ...
    [Migration("20230501114112_initial")]
            ...
            modelBuilder.Entity("MRA_Jobs.Domain.Entities.Note", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AplicationId = 1L,
                            Date = new DateTime(2023, 5, 1, 11, 41, 11, 963, DateTimeKind.Utc).AddTicks(8259),
                            Description = "",
                            UserId = 1L
                        });
                });
            ...
            modelBuilder.Entity("MRA_Jobs.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Age = 25,
                            BirthDay = new DateTime(2023, 5, 1, 11, 41, 11, 963, DateTimeKind.Utc).AddTicks(6880),
