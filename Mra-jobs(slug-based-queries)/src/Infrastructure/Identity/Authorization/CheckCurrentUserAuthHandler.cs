...
class CheckCurrentUserAuthHandler : AuthorizationHandler<CheckCurrentUserRequirement>
{
    private readonly ICurrentUserService _currentUser;
    public CheckCurrentUserAuthHandler(ICurrentUserService currentUser) => _currentUser = currentUser;
